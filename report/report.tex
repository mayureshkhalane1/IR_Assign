...
\textit{To be completed:} Generate expanded queries using the ``CoT'' prompting strategy and re-run retrieval/evaluation. Report metrics and discuss when LLM expansion helps or hurts.

\subsection{Task 5: LLM Query Expansion with PRF (Placeholder, Optional)}
\textit{To be completed:} Augment the prompt with pseudo-relevance feedback passages (PRF) and evaluate. Compare against Task 4 and the non-expanded baseline.
