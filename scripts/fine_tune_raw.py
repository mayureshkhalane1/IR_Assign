# Auto-generated from (Fine_tuning)_Final_assignment.ipynb# Code cells only; markdown removed.
# --- cell 1 ---# [ipynb-magic removed] !pip install sentence-transformers==3.4.1

# --- cell 2 ---# [ipynb-magic removed] !pip install pytrec_eval
# [ipynb-magic removed] !pip install bitsandbytes==0.43.1
...
# --- cell 5 ---from google.colab import drive
drive.mount('/content/gdrive')
base_path = "./gdrive/MyDrive/cross-encoder-reranker-ir-course-2026/"

# --- cell 6 ---# [ipynb-magic removed] !mkdir -p $base_path

# --- cell 7 ---#First, we define the transformer model we want to fine-tune
...
# --- cell 8 ---#We set num_labels=1, which predicts a continous score between 0 and 1
...
# --- cell 9 ---# [ipynb-magic removed] !wget https://msmarco.z22.web.core.windows.net/msmarcoranking/queries.tar.gz
# [ipynb-magic removed] !tar -xvzf  queries.tar.gz

# --- cell 10 ---### Now we read the MS Marco dataset
...
# --- cell 11 ---# We create a DataLoader to load our train samples
train_dataloader = DataLoader(train_samples, shuffle=True, batch_size=train_batch_size)

# --- cell 12 ---# We add an evaluator, which evaluates the performance during training
...
# --- cell 14 ---import sentence_transformers
